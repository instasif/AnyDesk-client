    ...
    <div>
      ...
      <div className="modal">
        <div className="modal-box relative">
          ...
          >✕</label>
            <h3 className="text-3xl font-bold text-orange-500 text-center ">{name}</h3>
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-3 mt-10">
            <input name="buyerName" type="text" placeholder="Type here" defaultValue={displayName} disabled className="input input-bordered input-warning w-full" />
            <input name="email" type="text" placeholder="Type here" disabled defaultValue={email} className="input input-bordered input-warning w-full" />
